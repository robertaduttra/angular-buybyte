...
export const produtos: IProduto[] = [
    ...
    { id: 5, descricao: "Fone de ouvido", preco: 299.99, descricaoPreco: "À vista no PIX", imagem: "/assets/fone-de-ouvido-1.jpg",quantidadeEstoque:7  },
    { id: 6, descricao: "Fone de ouvido bom", preco: 399.99, descricaoPreco: "À vista no PIX", imagem: "/assets/fone-de-ouvido-3.jpg", quantidadeEstoque: 60 },
    ...
    { id: 16, descricao: "Mouse Gamer Logitech", preco: 439.00, descricaoPreco: "À vista no PIX", imagem: "/assets/mouse-3.jpg", quantidadeEstoque:10 },
    { id: 17, descricao: "Mouse Gamer Redragon ", preco: 239.00, descricaoPreco: "À vista no PIX",  imagem: "/assets/mouse-gamer.jpg", quantidadeEstoque:10 },
    { id: 18, descricao: "PC Gamer Completo ", preco: 749.99, descricaoPreco: "À vista no PIX", imagem: "/assets/pc-gamer.jpg", quantidadeEstoque:10 },
